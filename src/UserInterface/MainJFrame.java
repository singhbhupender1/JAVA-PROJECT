...
public class MainJFrame extends javax.swing.JFrame {
    ...
    public MainJFrame() {
      ...
      JOptionPane.showMessageDialog(null,"Click OK to enter into the application.","Application", JOptionPane.OK_OPTION);
        
        int flag= JOptionPane.showConfirmDialog(this, "Press 'Yes' to enter into the application \n Press 'No' to exit the application","Warning", JOptionPane.YES_NO_OPTION);
        if(flag==1)
        {
          dispose();
          System.exit(0);
    ...
    private void initComponents() {
        ...
        loginJButton.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        logoutJButton.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
